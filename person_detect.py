...
class PersonDetect:
    ...
    def __init__(self, model_name, device, threshold=0.60):
        ...
        # input name and shpae
        self.input_name=next(iter(self.model.inputs))
        self.input_shape=self.model.inputs[self.input_name].shape
        
        # output name and shpae
    ...
    def predict(self, image):
        ...
        This method needs to be completed by you
        '''
        process_image = self.preprocess_input(image)
        result = self.network.infer(inputs={self.input_name:process_image})
        coordinates = result[self.output_name] # self.output_name=next(iter(self.model.outputs))
        # return coords and image
        coords,image = self.draw_outputs(coordinates, image)
        return coords,image
    
    def draw_outputs(self, coordinates, image):
        '''
        TODO: This method needs to be completed by you
        '''
        coords=[]
        for box in coordinates[0][0]: 
            conf = box[2]
    ...
    def preprocess_outputs(self, outputs):
        ...
        TODO: This method needs to be completed by you
        '''
        outputs = cv2.resize(outputs, (self.output_shape[3], self.output_shape[2]))
        return outputs
